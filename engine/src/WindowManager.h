...
public:
    /**
     * Initializes the window manager. Creates a window with the default width and height.
     */
    ...
    /**
     * Returns true if the key is repeated this frame. In other words, the key was pressed
     * in the previous frame and is still being pressed.
     */
    ...
    /**
     * Returns true if the mouse button is repeated this frame. In other words, the mouse button
     * was pressed in the previous frame and is still being pressed.
     */
...
private:
    ...
    /**
     * lastFrame is calculated in WindowManager because it relies on the glfwGetTime function.
     */
    ...
    /**
     * Defines the explicit mapping between GLFW key codes and the engine's key codes.
     */
